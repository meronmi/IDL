function _MannKendallTrendTest,x,undef=undef

;DO NOT USE, USE the IDL function r_correlate
...
;
;ex1. sl=MannKendallTrendTest(x,undef=-999.). x: ts. ex: x=[0.5, 0.1, 0.2, 0.1, 0.3], (dt=1)
;                                 no slope = -999.
;
