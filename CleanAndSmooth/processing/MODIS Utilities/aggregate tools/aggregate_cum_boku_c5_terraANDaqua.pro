...
PRO aggregate_cum_boku_c5_terraANDaqua
...
which = which[1]
imageFileBase = 'BOKU_C5_NDVIx10000_TA_sm_bil_from_2002'  ; original filtered NDVI stack file
...
nSeasons=21                        ; number of seasons in cumulated NDVI file
...
outFile = workPath+which+'_aggregated'+'_BOKU_C5_TERRAandAQUA'+ '.csv'
