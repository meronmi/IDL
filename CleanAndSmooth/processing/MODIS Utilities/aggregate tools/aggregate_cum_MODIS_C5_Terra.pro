...
PRO AGGREGATE_CUM_MODIS_C5_Terra

STARTTIME = SYSTIME(1)

; General settings (to be changed for different input)
dataPath='K:\ILRI\MODIS_C5\bil_files\'         ; location where administrative region-file is located
which = ['cumNDVI','maxNDVI']                   ; select which to aggregate
which = which[1]
imageFileBase = 'MODIS_C5_Terra_NDVIx10000_bil_cl_Sm_Ch'  ; original filtered NDVI stack file
...
outFile = workPath+which+'_aggregated'+'_MODIS_C5_TERRA'+ '.csv'
