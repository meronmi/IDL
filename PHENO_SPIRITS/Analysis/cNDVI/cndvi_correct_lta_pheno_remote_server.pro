PRO cNDVI_correct_lta_pheno_remote_server
  ...
  dirsep = '\'
  pheno_dir = '\\tsclient\X\Active Projects\FAO SOFI\ASAP20data\Phenology'
  pheno_base_name = 'pheno'
  cndvi_dir = 'F:\CumulatedNDVI'
