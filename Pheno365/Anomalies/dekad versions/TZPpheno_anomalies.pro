Function TZPpheno_anomalies, operation, fname_in, fname_out, dtype, ns, nl, nb, rel_fname, rel_threshold, val999, dekoc_oper
        ...
        'dltdev': BEGIN   
            ...
            IF (dekoc_oper EQ 1) THEN BEGIN
              ...
              IF f[0] NE -1 THEN BEGIN
                ...
                IF ((avgZ GT 36.0) OR (avgZ LE 0.0)) THEN avgZ = !VALUES.F_NAN
              ENDIF
            ENDIF
