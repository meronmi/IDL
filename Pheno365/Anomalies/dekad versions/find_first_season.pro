FUNCTION find_first_season, s0, s1, $ 
;ord_Xfrst_dek, Xfrst_year, ord_Yfrst_dek, Yfrst_year
...
;abs_dek_of_input_01_range = ord_dek_of_input_01_range - 1
;abs_dek_of_output_01_range = ord_dek_of_output_01_range - 1
...
;express it in dekoc
s0dekoc=pdekad2dekoc(s0, ord_dek_of_input_01_range, ord_dek_of_output_01_range)
s1dekoc=pdekad2dekoc(s1, ord_dek_of_input_01_range, ord_dek_of_output_01_range)
 
; consider only finite values and avg it
avg0=MEAN(s0dekoc[indf0], /DOUBLE)
avg1=MEAN(s1dekoc[indf1], /DOUBLE)
IF (avg0 GT 36.0) THEN avg0 = avg0 - 36.0  
IF (avg0 LE 0.0)  THEN avg0 = avg0 + 36.0
IF (avg1 GT 36.0) THEN avg1 = avg1 - 36.0  
IF (avg1 LE 0.0)  THEN avg1 = avg1 + 36.0
