FUNCTION smoothmv2, rseries, ignore_below, ignore_above, width, sseries
...
;   MM+    missing values are are replaced by the smoothed version .
...
;  MM+ Copy missing values in rseries to sseries:
