Function r2XvsY, fnameX, fnameY, inPath, ns, nl, nb, outPath, outBaseName, val999
;  Purpose:
...
;  Usage:
;     print, r2XvsY (fnameX, fnameY, inPath, ns, nl, nb, outPath, outBaseName, val999)
...
; 
; res = r2XvsY('vgt_1333_1413i_sc', 'PV_1333_1413i_sc', 'X:\Active Projects\MARSOP and transition\Proba V 1 km',7841,8289,17,'X:\Active Projects\MARSOP and transition\Proba V 1 km\corr','pvVSmp', !VALUES.F_NAN)
; 
; For peak vs SOS
...
fnameCorr = outPath+'\'+outBaseName+'_r2'
