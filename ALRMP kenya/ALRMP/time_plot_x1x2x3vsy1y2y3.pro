PRO time_plot_X1X2X3vsY1Y2Y3, jd1, y1,  jd2, y2, jd3, y3, title
...
h2 = PLOT(jd3, y3, LINESTYLE = '-', SYMBOL='o', COLOR='red', SYM_FILLED= 1, NAME = 'Tot_mortrate', $
...
!null = LEGEND(target=[h0, h1, h2], /AUTO_TEXT_COLOR, FONT_SIZE = fs, POSITION=[750, 520], $
