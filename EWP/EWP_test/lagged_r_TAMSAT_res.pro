...
PRO lagged_r_TAMSAT_res, xvar

;xVar = 'zEWP2000';'SPI1' ;'zEWP250''zEWP500''zEWP1000''zEWP1500''zEWP2000'
...
;this is the lag applied to x that is spi or ewp 
lag = INDGEN(10)
nLag = N_ELEMENTS(lag)
...
CASE xVar OF
  ...
  fn_x = 'E:\WA\EWP\SPI1 from Original Tamsat\AAA_spi_9835-1234_bil'
...
FOR l = 0, nl-1 DO BEGIN
  ...
  IF (xVar EQ 'SPI1') THEN x = x * 0.001
  count_NaN  = 0
 
  tomEQsos = 0L
  ;loop on samples
  FOR s = 0, ns-1 DO BEGIN
    IF ((s EQ 273) AND (l EQ 169))THEN BEGIN
      PRINT, 'CHECK'
    ENDIF
