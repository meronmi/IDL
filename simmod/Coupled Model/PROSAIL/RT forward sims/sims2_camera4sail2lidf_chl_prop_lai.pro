PRO simS2_Camera4SAIL2LIDF_chl_prop_lai
...
;    h1 = plot(JD, inv.lai[ind], LINESTYLE='', SYMBOL='x', COLOR='r', OVERPLOT=1)
  ...
  !null = LEGEND(target=[ghs1, ghs2, ghc2, ghc3, ghlai, ghCab], /AUTO_TEXT_COLOR, SHADOW=0, LINESTYLE=6, SAMPLE_WIDTH=0.1, TRANSPARENCY=100, FONT_SIZE=10)
