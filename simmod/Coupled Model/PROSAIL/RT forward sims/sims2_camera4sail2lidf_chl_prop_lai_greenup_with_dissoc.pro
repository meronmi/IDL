PRO simS2_Camera4SAIL2LIDF_chl_prop_lai_greenup_with_dissoc
  ...
  FOR i = 0, count-1 DO BEGIN
    ...
    IF (FINITE(lai) EQ 1) THEN BEGIN
      ...
      ENDIF ELSE BEGIN 
        ...
        IDL_PRO4SAIL2_lidf, 0.0,Car,Cbrown,0.0,Cm,Ns,Cab,Car,Cbrown,Cw,Cm,Ns,lidf_aDOWN,lidf_bDOWN,lidf_aDOWN,lidf_bDOWN,lai,hspot,fbPropLai,0,Cv,zeta, SZA,VZAsat,RAAsat,rsoil,resh,resv,absh,absa
      ENDELSE
      ...
      ENDIF ELSE BEGIN
       ...
       ; IDL_PRO4SAIL2_lidf, CabPropLai,Car,Cbrown,Cw,Cm,Ns,Cab,Car,Cbrown,Cw,Cm,Ns,lidf_a,lidf_b,lidf_aDOWN,lidf_bDOWN,lai,hspot,fb,diss,Cv,zeta, SZA,VZAcam,RAAcam,rsoil,resh,resv,absh,absa
        IDL_PRO4SAIL2_lidf, 0.0,Car,Cbrown,0.0,Cm,Ns,Cab,Car,Cbrown,Cw,Cm,Ns,lidf_aDOWN,lidf_bDOWN,lidf_aDOWN,lidf_bDOWN,lai,hspot,fbPropLai,0,Cv,zeta, SZA,VZAcam,RAAcam,rsoil,resh,resv,absh,absa
      ENDELSE
      ;PRINT, lai
      b_band = TOTAL(resv[subB] * sr.bSRnorm[subB])
      g_band = TOTAL(resv[subG] * sr.gSRnorm[subG])
