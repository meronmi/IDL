PRO IDL_PRO4SAIL2, Cab,Car,Cbrown,Cw,Cm,Ns, $
                   CabDOWN,CarDOWN,CbrownDOWN,CwDOWN,CmDOWN,NsDOWN, $
                   lidf_a,lidf_b,lai,hot,fb,diss,Cv,zeta, $
...
if (MEAN(m) gt 0.01) then begin
  ...
  denom=1.-rinf2*e2
  ;c
  J1ks=Jfunc1c(ks,m,lai2)
  J2ks=Jfunc2(ks,m,lai2)
  J1ko=Jfunc1c(ko,m,lai2)
  J2ko=Jfunc2(ko,m,lai2)
  ;c
  Ps=(sf+sb*rinf)*J1ks
  Qs=(sf*rinf+sb)*J2ks
...
if (MEAN(m) gt 0.01) then begin
  ...
  denom=1.-rinf2*e2
  ;c
  J1ks=Jfunc1c(ks,m,lai1)
  J2ks=Jfunc2(ks,m,lai1)
  J1ko=Jfunc1c(ko,m,lai1)
  J2ko=Jfunc2(ko,m,lai1)
  ;c
  Ps=(sf+sb*rinf)*J1ks
  Qs=(sf*rinf+sb)*J2ks
