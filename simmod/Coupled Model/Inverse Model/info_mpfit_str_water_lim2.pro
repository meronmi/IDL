FUNCTION info_mpfit_str_water_lim2, status, Bestnorm, npegged, pfree_index, parms, parinfo, fg, uppEnvFit, nIter, weightingScheme, eps_wlimOnOff
;info_mpfit = CREATE_STRUCT('inv',REPLICATE(CREATE_STRUCT('name', '', 'value', 0.0, 'format', ''), 6), $
;                           'WgtScheme', weightingScheme, 'pfree_index', pfree_index, $
;                           'parinfo', parinfo, 'fg', fg, 'parms', parms)
;info_mpfit = REPLICATE(CREATE_STRUCT('name', '', $
;             'value', 0.0, $
;             'format', ''), 10)
info_mpfit = CREATE_STRUCT('WgtScheme', weightingScheme, 'pfree_index', pfree_index, $
             'parinfo', parinfo, 'fg', fg, 'parms', parms, $
             'Status', status, 'BestChi2', Bestnorm, 'Fit2UpEnv',  uppEnvFit, $
             'UpEnvItr', nIter, 'eps_wlimOnOff', eps_wlimOnOff, 'npegged', npegged)
